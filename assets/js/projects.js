...
let render_projects = (slug) => {
    ...
    let projects_obj = [
        ...
        },
        {
            ...
            description: "A side scrolling 2d bullet hell where defeating an enemy causes enemy bullets to disappear.<br/> <a href="https://docs.google.com/document/d/1If2QAyn5Nk-3rgJq18c1JjRCY_Tn6W5dd2Yudgf8JTQ/edit?usp=sharing">Design Document Link</a>",
            categories: ['featured']
        },
        {
